...
public final class Config {
     ...
     * Desactiva enemigos si es cierto, útil para construir/probar niveles rápidamente.
     */
     ...
     * Cuánto espacio hay entre los bordes del juego y el límite de la cuadrícula jugable.
     */
    public static final int OUTSIDE_DISTANCE = 200;

    /**
     * Max score that can be achieved.
     * Puntuación máxima que se puede alcanzar.
     */
    ...
    /* COMIENZAN LOS INTERVALOS DE APARICIÓN PARA ENTIDADES */
    ...
    /* FINALIZAN LOS INTERVALOS DE APARICIÓN PARA ENTIDADES */


    /* MOVE SPEED FOR ENTITIES BEGIN */
    /* VELOCIDAD DE MOVER PARA COMIENZAR LAS ENTIDADES */
